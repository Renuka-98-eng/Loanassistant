...
{ // frame constructor 
	...
	balanceLabel.setText("Loan Balance"); balanceLabel.setFont(myFont);
...
private void computeButtonActionPerformed(ActionEvent e)
{
	...
	int months; double monthlyInterest, multiplier; 
...
// Compute number of payments 
		if (validateDecimalNumber(paymentTextField))
		{
			...
			{ 
				...
				{
					paymentTextField.setText(new DecimalFormat("0.00").format((int)(balance * monthlyInterest + 1.0))); payment = Double.valueOf(paymentTextField.getText()).doubleValue();
					} 
				else 
				{
...
monthsTextField.setText(String.valueOf(months)); 
	...
	payment = Double.valueOf(paymentTextField.getText()).doubleValue();
	// show analysis 
	analysisTextArea.setText("Loan Balance: $" + new DecimalFormat("0.00").format(balance)); analysisTextArea.append("\n" + "Interest Rate: " + new DecimalFormat("0.00").format(interest) + "%");
	...
	{ 
		...
		{ 
			...
			computePayment = true; paymentButton.setVisible(false);
